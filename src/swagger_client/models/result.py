...
class Result(object):
    ...
    def __init__(self, result=None, row=None):  # noqa: E501
    ...
    @property
    def row(self):
        """Gets the row of this Result.  # noqa: E501


        :return: The row of this Result.  # noqa: E501
        :rtype: float
        """
        return self._row
    ...
    @row.setter
    def row(self, row):
        """Sets the row of this Result.


        :param row: The row of this Result.  # noqa: E501
        :type: float
        """
